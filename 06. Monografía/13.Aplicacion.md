...
Para conectarse a la base de datos, es necesario contar con una instancia de Postgres disponible en el puerto `5432`, con un usuario de nombre `postgres`, contraseña `123456` y base de datos de nombre `san-fernando-db`. Para dar el poblamiento inicial a la base de datos, antes de ejecutar la aplicación, es necesario ejecutar el script SQL especificado en la sección de [Carga de datos](09.CargaDatos.md).
