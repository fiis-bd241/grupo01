# Presentación Grupal 03: Proceso de Negocio, Requerimientos y Prototipo (Avance)
...
![Diagrama sin título drawio](imagenes/diagramas/proceso.png)
...
![image](../entregable%202/imagenes/prototipo-1.png)


![image](../entregable%202/imagenes/prototipo-2.png)


![image](../entregable%202/imagenes/prototipo-3.png)

### Módulo 2: Seguimiento

![image](imagenes/prototipo/seguimiento-1.jpeg)


![image](imagenes/prototipo/seguimiento-2.jpeg)


![image](imagenes/prototipo/seguimiento-3.jpeg)

### Módulo 3: Almacén

![image](imagenes/prototipo/almacen-1.png)

![image](imagenes/prototipo/almacen-2.png)

![image](imagenes/prototipo/almacen-3.png)

![image](imagenes/prototipo/almacen-4.png)

![image](imagenes/prototipo/almacen-5.png)

![image](imagenes/prototipo/almacen-6.png)

[Figma](https://www.figma.com/file/nnoiQDwJ9WstLLZmVisdpw/Untitled?type=design&node-id=0-1&mode=design&t=ztZFDIkEuNp6ykcn-0)

### Módulo 5: Reportes

![modulo-5f](imagenes/prototipo/reportes.png)

### Módulo 6: Reclamos

![modulo-6](imagenes/prototipo/reclamos.png)
...
[![Entrevista](../entregable%202/imagenes/video_preview.png)](http://www.youtube.com/watch?v=DPxvZC3R6Ws "Entrevista a Joselin Torres")

Los detalles de la reunión fueron registrados en la [acta](../entregable%202/acta-entrevista-20240401.md) respectiva, así como también se elaboró una [transcripción](../entregable%202/transcripcion-entrevista-20240401.md) de las preguntas y respuestas realizadas durante la entrevista, además se generó un [resumen](../entregable%202/Resumen-transcripcion.md) donde se sintetiza los procesos más importantes con un cierto orden, con el fin de comprender mejor los procesos de San Fernando.
